...
├─────────────────────────────────────────────────────────────────┤
│                     Core Type Aliases                           │
│         NodeId │ ContentHash │ DhtKey = Hash                   │
├─────────────────────────────────────────────────────────────────┤
│  DHT Types    │  Storage Types │  Economic Types │ Config Types │
├─────────────────────────────────────────────────────────────────┤
│         Statistics Types │ Network Address Types               │
└─────────────────────────────────────────────────────────────────┘
```
...
fn test_hash_type_aliases() {
    let node_id: NodeId = Hash::from_bytes(&[1u8; 32]);
